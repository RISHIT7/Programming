...
QNA_tool::QNA_tool()
{
    mainobj = vector<vector<vector<SymbolTable>>>(99); // {bookid, page numer, pargraph, AVL tree}
...
vector<pair<string, double>> QNA_tool::scoring(string sentence) // rolling hs type scoring
{
    vector<string> words = ppr(sentence);
...
vector<QNA_tool::scored_para> QNA_tool::tity(string sentence) // paragraph scoring
{
...
void QNA_tool::query_llm(string filename, Node *root, int k, string API_KEY, string question)
{
    ...
    // outfile << "Given the following paragraphs, please provide a concise and comprehensive response to the above question. Limit your answer to 150 words and 1 paragraph." <<"\n";
    outfile << "Convert the question into individuall words and search for them in the paragraphs, collect the data and answer the question in 150 words and 1 paragraph" <<"\n";
