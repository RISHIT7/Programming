...
void byte_buffer_write_16(ByteBuffer* bb, uint16_t data) {
	byte_buffer_write_8(bb, (data & 0xFF00) >> 8);
	byte_buffer_write_8(bb, (data & 0x00FF));
}

void byte_buffer_write_32(ByteBuffer* bb, uint32_t data) {
	byte_buffer_write_8(bb, (data & 0xFF000000) >> 24);
	byte_buffer_write_8(bb, (data & 0x00FF0000) >> 16);
	byte_buffer_write_8(bb, (data & 0x0000FF00) >> 8);
	byte_buffer_write_8(bb, (data & 0x000000FF));
}
