...
class Ball():
    ...
    def draw(self):
        if self.shape.collision_type != 0:
...
balls = [Ball(random.randint(0, WIDTH), random.randint(0, HEIGHT), i+1)
         for i in range(100)]
balls.append(Ball(400, 400, 0))
floor_d = Walls(0, 798, 1200, 798)
floor_u = Walls(0, 0, 1200, 0)
Wall_l = Walls(0, 0, 0, 800)
Wall_r = Walls(1198, 0, 1198, 800)

handlers = [Space.add_collision_handler(0, i + 1) for i in range(100)]
